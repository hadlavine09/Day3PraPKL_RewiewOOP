            ...
            <div class="card-body">
                ...
                <table class="table table-striped" style="text-align:center">
                    ...
                    <tbody>
                        ...
                        <td>
                            <a href="show.php?no=<?php echo $data['no']; ?>" class="btn btn-warning" style="margin:10px;">Show</a> 
                            <a href="edit.php?no=<?php echo $data['no']; ?>" class="btn btn-success"style="margin:10px;">Edit</a> 
